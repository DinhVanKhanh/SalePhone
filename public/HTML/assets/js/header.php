...
<html lang="en">
	<head>
	    ...
	    <link rel="stylesheet" href="HTML/assets/css/green.css">
	    <link rel="stylesheet" href="HTML/assets/css/owl.carousel.css">
		<link rel="stylesheet" href="HTML/assets/css/owl.transitions.css">
		...
		<link rel="stylesheet" href="HTML/assets/css/config.css">

		<link href="HTML/assets/css/green.css" rel="alternate stylesheet" title="Green color">
		<link href="HTML/assets/css/blue.css" rel="alternate stylesheet" title="Blue color">
		<link href="HTML/assets/css/red.css" rel="alternate stylesheet" title="Red color">
		<link href="HTML/assets/css/orange.css" rel="alternate stylesheet" title="Orange color">
		<link href="HTML/assets/css/navy.css" rel="alternate stylesheet" title="Navy color">
		<link href="HTML/assets/css/dark-green.css" rel="alternate stylesheet" title="Darkgreen color">
        ...
        <nav class="top-bar animate-dropdown">
            <div class="container">
                <div class="col-xs-12 col-sm-6 no-margin">
                    <ul>
                        <li><a href="?view=views">Home</a></li>
                    </ul>
                 </div>
            </div><!-- /.container -->
        </nav><!-- /.top-bar -->
...
<div class="logo">
	<!-- <a href="index.html"> -->
		<!--<img alt="logo" src="HTML/assets/images/logo.svg" width="233" height="54"/>-->
		<!--<object id="sp" type="image/svg+xml" data="HTML/assets/images/logo.svg" width="233" height="54"></object>-->
        ...
        <div class="col-xs-12 text-center mb-5 col-md-12 mt-4">
        <a style="color:rgba(255,255,255,1);font-size: 30px;background-image: linear-gradient(-180deg,#39D539,#AAFFA2,#2DCE2D)">Mobile Shoping</a>
        </div>
	</a>
</div><!-- /.logo -->
<!-- ============================================================= LOGO : END ============================================================= -->		</div><!-- /.logo-holder -->
    ...
    <div class="phone inline">
        <i class="fa fa-phone"></i> 0121333015
    </div>
    <div class="contact inline">
        <i class="fa fa-envelope"></i> dinhvankhanh107@<span class="le-color">gmail.com</span>
    </div>
</div><!-- /.contact-row -->
<!-- ============================================================= SEARCH AREA ============================================================= -->
<?php  
        if(isset($_GET['xoa_id']) && isset($_GET['in'])&& $_GET['in'] == 'cart'){
            unset($_SESSION['cart'][$_GET['xoa_id']]);
           
        }

        if(isset($_GET['id']) && isset($_GET['in'])&& $_GET['in'] == 'cart'){
            $id = $_GET['id'];
            @$_SESSION['cart'][$id] +=1;
...
?>
    ...
    <form  action="?view=watch&on=form&in=search" method="post">
        
           
           <div class="col-md-12" style="margin-top: 13px">
            
            <input class="form-control" type="text" name="txtSearch" class="search-field" placeholder="Tìm kiếm sản phẩm" />
           ...
           <!--  <ul class="categories-filter animate-dropdown">
            ...
            <button name="search" class="btn btn-primary btn-success" style="position: absolute; top: 0; right: 0;">Tìm kiếm</button>
          </div>
            <!-- </div> -->
        ...
        <div class="basket">
            ...
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                <div class="basket-item-count">
                    ...
                    <img src="HTML/assets/images/icon-cart.png" alt="" />
                </div>
                ...
                <div class="total-price-basket"> 
                    ...
                    <span class="total-price">
                        ...
                        <input type="text" style="width: 180px; border: 0"
                    ...
                    <div class="basket-item">
                        ...
                        <div class="row">
                            <div class="col-xs-4 col-sm-4 no-margin text-center">
                                <div class="lazy">
                                    <img alt="" width="50px" height="50px" src="uploads/<?= $dong['hinhanh']?>" />
                                </div>
                            </div>
                            <div class="col-xs-8 col-sm-8 no-margin">
                                <div class="title"><?= $dong['mota']?></div>
                                <a class="price"><?= number_format($dong['gia']). " VNĐ"?></a>
                                <input type="text" name="pri" class="pri" data-pri="<?= $dong['gia'] ?>" style="display: none;">
                    ...
                    <div class="basket-item">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12">
                                <a href="?view=watch&on=form&in=cart" class="cart le-button inverse">Xem giỏ hàng</a>
                            </div>
                           <!--  <div class="col-xs-12 col-sm-6">
                                <a href="?view=watch&on=form&in=checkout" class="checkout le-button">Checkout</a>
                            </div> -->
                        </div>
                    </div>
                </li>
...
<!-- ============================================================= HEADER : END ============================================================= -->		<div id="top-banner-and-menu">
	...
	<!-- <script src="HTML/assets/js/jquery-1.10.2.min.js"></script> -->
	<!-- <script src="HTML/assets/js/jquery-migrate-1.2.1.js"></script> -->
    <script src="https://code.jquery.com/jquery-3.3.1.min.js"></script>
    <script src="https://code.jquery.com/jquery-migrate-3.0.1.min.js"></script>
	<script src="HTML/assets/js/bootstrap.min.js"></script>
	<script src="http://maps.google.com/maps/api/js?sensor=false&amp;language=en"></script>
	<script src="HTML/assets/js/gmap3.min.js"></script>
	<script src="HTML/assets/js/bootstrap-hover-dropdown.min.js"></script>
	<script src="HTML/assets/js/owl.carousel.min.js"></script>
	<script src="HTML/assets/js/css_browser_selector.min.js"></script>
	<script src="HTML/assets/js/echo.min.js"></script>
	<script src="HTML/assets/js/jquery.easing-1.3.min.js"></script>
	<script src="HTML/assets/js/bootstrap-slider.min.js"></script>
    <script src="HTML/assets/js/jquery.raty.min.js"></script>
    <script src="HTML/assets/js/jquery.prettyPhoto.min.js"></script>
    <script src="HTML/assets/js/jquery.customSelect.min.js"></script>
	...
	<script src="HTML/switchstylesheet/switchstylesheet.js"></script>
	...
	<script>
        ...
        total();
        function total(){
            setTimeout(function() { // cho nó xử lý nhanh  hơn
            tong = 0;
            $('.pri').each(function() {
                tong += $(this).data('pri');
            });
             $('.value').val(new Intl.NumberFormat().format(tong)+ " VNĐ");
            }, 100);
