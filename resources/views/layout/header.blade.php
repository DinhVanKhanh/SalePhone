...
<!-- ============================================================= SEARCH AREA ============================================================= -->
    ...
    <form  action="layout/module/timkiem" method="post">
                {{ csrf_field() }}   
        <div class="col-md-12" style="margin-top: 13px">
            <div class="col-md-9 col-xs-9">
                <input class="form-control" style="width: 115% !important" type="text" name="txtSearch" class="search-field" placeholder="Tìm kiếm sản phẩm" />   
            </div>               <!--  <ul class="categories-filter animate-dropdown">
                <li class="dropdown">
            ...
            <div class="col-md-3 col-xs-3">  
                <button name="search" class="btn btn-primary btn-success" style="">Tìm kiếm</button>
            </div>
        </div>
            <!-- </div> --> 
    </form>
                    ...
                    <div class="basket-item">
                        ...
                        <div class="row">
                            <div class="col-xs-4 col-sm-4 no-margin text-center">
                                <div class="lazy">
                                    <img alt="" width="50px" height="50px" src="uploads/<?= $value['attributes']['hinhanh']?>" />
                                </div>
                            </div>
                            <div class="col-xs-8 col-sm-8 no-margin">
                                <div class="title"><?= $value['attributes']['mota']?></div>
                                <a class="price"><?= number_format($value['price']). " VNĐ"?></a>
                                <input type="text" name="pri" class="pri" data-pri="<?= $value['price'] ?>" style="display: none;">
                    ...
                    <div class="basket-item">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12">
                                <a href="layout/module/giohang" class="cart le-button inverse">Xem giỏ hàng</a>
                            </div>
...
<!-- ============================================================= HEADER : END ============================================================= -->		<div id="top-banner-and-menu">
   ...
   <!--  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js"></script>
	...
	<script src="HTML/assets/js/scripts_1.js"></script>
