...
<footer id="footer" class="color-bg" style="padding: 0 !important">
...
<!-- <div class="contact-info"> -->
    ...
    <!-- <p class="regular-bold"> Địa chỉ: 371 Nguyễn Kiệm, Gò Vấp </p> -->
...
<!-- ============================================================= CONTACT INFO : END ============================================================= -->            <!-- </div> -->
                ...
                <!-- ============================================================= LINKS FOOTER ============================================================= -->
<div class="col-xs-12 col-md-12 no-margin mb-5">
<div class="col-md-3 col-xs-12 text-center">
    <div class="link-widget" >
        <div class="widget">
            <h4>Chuyên cung cấp</h4><hr>
            <ul>
                <li><a >Điện thoại xách tay</a></li>
                <li><a >Điện thoại phổ biến</a></li>
                <li><a >Mức giá cạnh tranh</a></li><br/>
            </ul>
        </div><!-- /.widget -->
    </div><!-- /.link-widget -->
</div>
<div class="col-md-3 col-xs-12 text-center">
    <div class="link-widget">
        <div class="widget">
            <h4>Thông tin liên lạc</h4><hr>
            <ul>
               
                <li><a>1551010050-Đinh Văn Khánh</a></li><br/>
            </ul>
        </div><!-- /.widget -->
    </div><!-- /.link-widget -->
</div>
<div class="col-md-3 col-xs-12 text-center">
    <div class="link-widget">
        <div class="widget">
            <h4>Giáo viên hướng dẫn</h4><hr>
            <ul>
                <li><a>Th.s Nguyễn Thị Mai Trang</a></li><br/>
...
<div class="col-md-3 col-xs-12 text-center">
    <div class="link-widget">
        <div class="widget">
            <h4>Liên hệ</h4><hr>
            <ul>
                <li><a>371 Nguyễn Kiệm, Gò Vấp</a></li><br/>
            </ul>
        </div><!-- /.widget -->
    </div><!-- /.link-widget -->
</div>
    ...
    <div class="copyright-bar">
        <div class="container">
            <div class="col-xs-12 col-sm-8 no-margin">
                <div class="copyright">
                    &copy; <a>By Đinh  Văn Khánh</a>
                </div>
            </div>
            <!-- <div class="col-xs-12 col-sm-2 no-margin"> -->
                <!-- <div class="payment-methods ">
                    <ul>
                        <li><img alt="" src="HTML/HTML/assets/images/payments/payment-visa.png"></li>
                        <li><img alt="" src="HTML/assets/images/payments/payment-master.png"></li>
                        <li><img alt="" src="HTML/assets/images/payments/payment-paypal.png"></li>
                        <li><img alt="" src="HTML/assets/images/payments/payment-skrill.png"></li>
                    </ul>
                </div>  --><!-- /.payment-methods -->
             <!-- </div> -->
         </div><!-- /.container -->
